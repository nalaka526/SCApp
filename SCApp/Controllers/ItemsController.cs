...
namespace SCApp.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,CategoryId,Price,IsActive")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,CategoryId,Price,IsActive")] Item item)
        {
            if (ModelState.IsValid)
            {
